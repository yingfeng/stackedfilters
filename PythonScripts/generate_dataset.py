...
parser.add_argument("--augment", action="store_true", default=False,
                    help="Whether to augment dataset by adding www. and removing www. when possible.")
...
def generate_dataset(dataset_path, desired_positive_categories, desired_negative_categories, save_path="dataset.json"):
    ...
    assert (len(set(desired_positive_categories + desired_negative_categories)) == len(
        desired_positive_categories) + len(desired_negative_categories))
