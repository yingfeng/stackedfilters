...
class BloomFilter(object):
    ...
    def initializeBloomFromSize(items_count, size, get_digest):
        bitsPerElement = size / items_count
        FPR = (0.5 ** (math.log(2))) ** (bitsPerElement)
        return BloomFilter(items_count, FPR, get_digest)
