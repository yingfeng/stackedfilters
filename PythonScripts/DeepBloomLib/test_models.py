...
def test_perfect_model(positives, negatives):
    ...
    model.fit(positives + negatives_train,
              [1 for _ in range(len(positives))] + [0 for _ in range(len(negatives_train))])
...
def test_gru_model(positives, negatives, data_fraction=1.0, fp_rate=0.01, lr=0.001, pca_embedding_dim=None, maxlen=50,
                   gru_size=16, batch_size=1024, hidden_size=None, second_gru_size=None, decay=0.0001, epochs=30):
    ...
    model = GRUModel('../data/glove.6B.50d-char.txt', 50, lr=lr, pca_embedding_dim=pca_embedding_dim, maxlen=maxlen,
                     gru_size=gru_size, batch_size=batch_size, hidden_size=hidden_size, second_gru_size=second_gru_size,
...
if __name__ == '__main__':
    ...
    test_gru_model(positives, negatives, data_fraction=0.5, fp_rate=0.01, pca_embedding_dim=16, lr=0.001, maxlen=50,
                   gru_size=16)
